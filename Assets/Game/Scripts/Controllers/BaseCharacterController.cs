...
namespace Game {
    public class BaseCharacterController : MonoBehaviour
    {
        ...
        [SerializeField] Behavior[] abilities;
        ...
        private void SubscribePlayerControls() {
            characterData.playerControls.Player.Skate.started += context => {
                characterData.playerData.wishSkateDown = true;
                characterData.playerData.wishSkatePress = true;
            };
    
            characterData.playerControls.Player.Skate.canceled += context => {
                characterData.playerData.wishSkateDown = false;
            ...
            characterData.playerControls.Player.Sprint.started += context => {
                characterData.playerData.wishSprintDown = true;
            };
    
            characterData.playerControls.Player.Sprint.canceled += context => {
                characterData.playerData.wishSprintDown = false;
                characterData.playerData.wishSprintUp = true;
            };
